            ...
            <TableHead>
              <TableRow>
                {columns.map((column, index) => (
                  <TableCell key={index} onClick={() => sortTable(column.key)} sx={{ fontFamily: 'Outfit', textAlign: 'center' }}>
                    {column.label}
                ...
                <TableCell></TableCell> {/* New column for delete button */}
                <TableCell></TableCell> {/* New column for delete button */}
              </TableRow>
            </TableHead>
            <TableBody>
              {filteredData.map((row, rowIndex) => (
                <TableRow key={rowIndex}>
                  {columns.map((column, columnIndex) => (
                    <TableCell key={columnIndex} sx={{ fontFamily: 'Outfit', fontWeight: 'bold', textAlign: 'center' }}>
                      {column.key.includes('.')
