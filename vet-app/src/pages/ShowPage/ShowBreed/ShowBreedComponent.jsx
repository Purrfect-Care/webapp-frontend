...
const ShowBreedComponent = () => {
    ...
    return (
        <>
        <div>
            {openTable && <DynamicTable columns={columns} data={breedData} onDelete={handleDelete} onEdit={editBreed} title={"Rasy"} />}
            {openEditForm && (<AddBreed initialValues={selectedBreed} onClose={closeForm} snackbar={openSnackbar}/>)}
