...
const ViewVisit = ({
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const [visitTypes, visitSubtypes, patientJSON, employeeJSON] =
          await Promise.all([
      ...
      <div className="popup-form-static">
            ...
            <div className="form-section-static">
              ...
              <div className="form-section-row-static">
                ...
                <label>
                  ...
                  <div className="value-static">
                    <p>
                      {dayjs(formValues.visit_datetime).format(
                        "YYYY-MM-DD HH:mm"
                      )}
                    </p>
                  </div>
        ...
        <div className="button-container-static">
          <button
            ...
            onClick={() => deleteVisit(initialValues)}
          >
            Usuń
          </button>
          <button className="form-button-static" onClick={setEdit}>
            Edytuj
          </button>
          <button className="form-button-static" onClick={onClose}>
            Zamknij
          </button>
        </div>
        {showConfirmation && (
