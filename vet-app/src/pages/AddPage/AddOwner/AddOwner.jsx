    ...
    <div className="add-owner">
      ...
      <div className="owner-form">
        ...
        <form onSubmit={handleSubmit}>
          ...
          {errorMessage && (
            <span className="span-addowner-error">{errorMessage}</span>
          )}
          ...
          <div className="button-container-add-owner">
            ...
            {initialValues && (
              <button type="submit" className="submit-button-update-owner">
                Edytuj
              </button>
            )}
            {initialValues && (
              <button className="cancel-button-owner" onClick={() => onClose()}>
                Anuluj
              </button>
            )}
          </div>
